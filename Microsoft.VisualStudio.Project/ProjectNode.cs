...
namespace Microsoft.VisualStudio.Project {
    ...
    public abstract partial class ProjectNode : HierarchyNode,
        ...
        private static readonly FrameworkName DefaultTargetFrameworkMoniker = new(".NETFramework", new Version(4, 0));
        ...
        {                                      // Name                    Target (MSBuild)
            new("Built",                 "BuiltProjectOutputGroup"),
            new("ContentFiles",          "ContentFilesProjectOutputGroup"),
            new("LocalizedResourceDlls", "SatelliteDllsProjectOutputGroup"),
            new("Documentation",         "DocumentationProjectOutputGroup"),
            new("Symbols",               "DebugSymbolsProjectOutputGroup"),
            new("SourceFiles",           "SourceFilesProjectOutputGroup"),
            new("XmlSerializer",         "SGenFilesOutputGroup"),
        };
        ...
        /// </summary>
        private List<IVsBuildDependency> buildDependencyList = new();
        ...
        /// </summary>
        private Dictionary<Type, Guid> catidMapping = new();
        ...
        private readonly List<KeyValuePair<string, prjBuildAction>> _availableFileBuildActions = new();
        #endregion
            ...
            set {
                if (projectIdGuid != value) {
                    ...
                    if (buildProject != null) {
                        SetProjectProperty("ProjectGuid", _PersistStorageType.PST_PROJECT_FILE, projectIdGuid.ToString("B"));
                    }
                }
            }
        }
        ...
        protected virtual bool IsProjectFileDirty {
            get {
                ...
                return _isDirty || !File.Exists(document);
            }
        }
        ...
        protected virtual bool ShowProjectInSolutionPage {
            ...
            set {
                showProjectInSolutionPage = value;
            }
        }
        ...
        public Microsoft.VisualStudio.Shell.Url BaseUri {
            get {
                if (baseUri == null && buildProject != null) {
                    string path = System.IO.Path.GetDirectoryName(buildProject.FullPath);
        ...
        public FrameworkName TargetFrameworkMoniker {
            get {
                ...
                if (_options != null) {
                    return _options.TargetFrameworkMoniker ?? DefaultTargetFrameworkMoniker;
                } else {
            ...
            set {
                ...
                if (_options.TargetFrameworkMoniker != value) {
                    OnTargetFrameworkMonikerChanged(_options, _options.TargetFrameworkMoniker, value);
                }
            }
        }
        ...
        protected bool DisableQueryEdit {
            get {
                return disableQueryEdit;
            }

            set {
                disableQueryEdit = value;
            }
        }
        ...
        public HierarchyNodeCollection ItemIdMap {
            get {
                if (itemIdMap == null)
                    itemIdMap = CreateHierarchyNodeCollection();
        ...
        protected bool IsIdeInCommandLineMode {
            get {
                bool cmdline = false;
                var shell = _site.GetService(typeof(SVsShell)) as IVsShell;
                if (shell != null) {
                    object obj;
        ...
        public SuppressEvents EventTriggeringFlag {
            get {
                return eventTriggeringFlag;
            }
            set {
                eventTriggeringFlag = value;
            }
        }
        ...
        public virtual void AddNonmemberItems() {
            ...
            GetRelativeFileSystemEntries(ProjectFolder, null, files, folders);

            // exclude the items which are the part of the build.
            ExcludeProjectBuildItems(files, folders);

            var oldEventTriggeringFlag = EventTriggeringFlag;
            EventTriggeringFlag = SuppressEvents.Hierarchy;
            try {
                AddNonmemberFolderItems(folders);
                AddNonmemberFileItems(files);
            } finally {
        ...
        protected virtual void ExcludeProjectBuildItems(IList<string> fileList, IList<string> folderList) {
            ...
            ICollection<MSBuild.ProjectItem> projectItems = BuildProject.Items;
            ...
            foreach (MSBuild.ProjectItem buildItem in projectItems) {
                if (folderMap != null &&
                    ...
                    {
                        relativePath = GetRelativePath(ProjectFolder, relativePath);
                    }
            ...
            foreach (string folderKey in folderList) {
                ...
                foreach (string folder in folders) {
                    ...
                    if (childNode == null) {
                        ...
                        FolderNode folderNode = CreateFolderNode(childNodeId, element);
        ...
        protected virtual void AddNonmemberFileItems(IList<string> fileList) {
            ...
            foreach (string fileKey in fileList) {
                ...
                HierarchyNode childNode = CreateFileNode(element);
                parentNode.AddChild(childNode);
        ...
        public override int SetEditLabel(string label) {
            ...
            if (!File.Exists(Url)) {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, SR.GetString(SR.FileOrFolderCannotBeFound, CultureInfo.CurrentUICulture), ProjectFile));
            }
        ...
        public override int SetSite(Microsoft.VisualStudio.OLE.Interop.IServiceProvider site) {
            ...
            taskProvider = new TaskProvider(_site);
        ...
        protected override void Dispose(bool disposing) {
            ...
            try {
                    ...
                    try {
                        ...
                        try {
                            if (projectEventsProvider != null) {
                                projectEventsProvider.ProjectFileOpened -= OnAfterProjectOpen;
                            }
                            if (taskProvider != null) {
                ...
                if (_userBuildProject != null) {
                    ...
                    _userBuildProject.ProjectCollection.UnloadProject(_userBuildProject.Xml);
                    _userBuildProject = null;
                }
        ...
        protected override int ExecCommandOnNode(Guid cmdGroup, uint cmd, OLECMDEXECOPT nCmdexecopt, IntPtr pvaIn, IntPtr pvaOut) {
            if (cmdGroup == VsMenus.guidStandardCommandSet97) {
                ...
                switch ((VsCommands2K)cmd) {
                    ...
                    case ProjectFileConstants.CommandExploreFolderInWindows:
                        ExploreFolderInWindows(ProjectFolder);
                        return VSConstants.S_OK;
                }
            }
        ...
        public virtual VSADDRESULT RunWizard(HierarchyNode parentNode, string itemName, string wizardToRun, IntPtr dlgOwner) {
            ...
            IVsExtensibility3 ivsExtensibility = GetService(typeof(IVsExtensibility)) as IVsExtensibility3;
            ...
            IVsDetermineWizardTrust wizardTrust = GetService(typeof(SVsDetermineWizardTrust)) as IVsDetermineWizardTrust;
            if (wizardTrust != null) {
        ...
        protected virtual HierarchyNode AddDependentFileNode(IDictionary<String, MSBuild.ProjectItem> subitems, string key, IDictionary<string, HierarchyNode> nodeCache) {
            ...
            if (subitems.ContainsKey(dependentOf)) {
                ...
                uint parentItemID;
                string path = Path.Combine(ProjectFolder, dependentOf);
            ...
            if (parent != null)
                ...
                newNode = AddIndependentFileNode(item, nodeCache);
        ...
        public virtual void PrepareBuild(string config, string platform, bool cleanBuild) {
            ...
            ProjectOptions options = GetProjectOptions(config, platform);
        ...
        public virtual MSBuildResult Build(uint vsopts, string config, string platform, IVsOutputWindowPane output, string target) {
            lock (ProjectNode.BuildLock) {
                ...
                try {
                    SetBuildConfigurationProperties(config, platform);
        ...
        public virtual void SetProjectProperty(string propertyName, _PersistStorageType storageType, string propertyValue) {
            ...
            if (!String.Equals(oldValue, propertyValue, StringComparison.Ordinal)) {
                ...
                if (storageType == _PersistStorageType.PST_PROJECT_FILE && !ProjectManager.QueryEditProjectFile(false)) {
        ...
        public virtual ProjectOptions GetProjectOptions(string config, string platform) {
            ...
            // already occurred.
            if (_options != null
                && string.Equals(_options.Config, config, StringComparison.OrdinalIgnoreCase)
                && string.Equals(_options.Platform, platform, StringComparison.OrdinalIgnoreCase)) {
                if (config != null && platform != null) {
                    ...
                    ProjectOptions currentOptions = _options;
                    SetConfiguration(config, platform);
            ...
            string outputPath = GetOutputPath(currentConfig);
            ...
            options.OutputAssembly = outputPath + GetAssemblyName(config, platform);
            ...
            _options = options; // do this AFTER setting configuration so it doesn't clear it.
            return options;
        }
        ...
        public virtual void OnTargetFrameworkMonikerChanged(ProjectOptions options, FrameworkName currentTargetFramework, FrameworkName newTargetFramework) {
            ...
            var retargetingService = _site.GetService(typeof(SVsTrackProjectRetargeting)) as IVsTrackProjectRetargeting;
            if (retargetingService == null) {
                ...
                Marshal.ThrowExceptionForHR(UpdateTargetFramework(InteropSafeIVsHierarchy, currentTargetFramework.FullName, newTargetFramework.FullName));
            } else {
                Marshal.ThrowExceptionForHR(retargetingService.OnSetTargetFramework(InteropSafeIVsHierarchy, currentTargetFramework.FullName, newTargetFramework.FullName, this, true));
            }
        }
        ...
        public virtual string GetAssemblyName(string config, string platform) {
            SetConfiguration(config, platform);
            return GetAssemblyFileName(currentConfig);
        }
        ...
        public virtual FileNode CreateFileNode(string file) {
            ProjectElement item = AddFileToMSBuild(file);
        ...
        protected virtual FolderNode VerifySubfolderExists(string path, HierarchyNode parent, IDictionary<string, HierarchyNode> nodeCache) {
            ...
            if (nodeCache == null || !nodeCache.TryGetValue(strFullPath, out cachedNode)) {
                ...
                if (uiItemId != (uint)VSConstants.VSITEMID.Nil) {
                    ...
                    cachedNode = NodeFromItemId(uiItemId);
                ...
                if (itemid != VSConstants.VSITEMID_NIL && hierarchyPtr != IntPtr.Zero) {
                    ...
                    if (itemid != VSConstants.VSITEMID_SELECTION) {
                        ...
                        if (Utilities.IsSameComObject(InteropSafeIVsHierarchy, hierarchy)) {
                            ...
                            NestedProjectNode node = GetNestedProjectForHierarchy(hierarchy);
                            if (node != null) {
                                selectedNodes.Add(node);
                            }
                        }
                        ...
                        if (!isSingleHierarchy || (isSingleHierarchy && Utilities.IsSameComObject(InteropSafeIVsHierarchy, hierarchy))) {
                            ...
                            foreach (VSITEMSELECTION vsItemSelection in vsItemSelections) {
                                if (isSingleHierarchy || Utilities.IsSameComObject(InteropSafeIVsHierarchy, vsItemSelection.pHier)) {
                                    HierarchyNode node = NodeFromItemId(vsItemSelection.itemid);
                                    if (node != null) {
                                        selectedNodes.Add(node);
                                    }
                                }
        ...
        public override void UpdateSccStateIcons() {
            ...
            for (HierarchyNode n = FirstChild; n != null; n = n.NextSibling) {
        ...
        public virtual int ToggleShowAllFiles() {
            ...
            //{
            showAllFilesEnabled = !showAllFilesEnabled; // toggle the flag

            if (ShowAllFilesEnabled) {
                AddNonmemberItems();
            } else {
                RemoveNonmemberItems();
            }
            //}
        ...
        protected virtual void Reload() {
            ...
            try {
                ...
                isClosed = false;
                eventTriggeringFlag = SuppressEvents.Hierarchy | SuppressEvents.Tracker;
                ...
                ProcessFiles(nodeCache);

                ProcessFolders(nodeCache);
                ...
                eventTriggeringFlag = SuppressEvents.None;
                disableQueryEdit = false;
            }
        }
        ...
        protected virtual void RenameProjectFile(string newFile) {
            ...
            if (ErrorHandler.Succeeded(vsSolution.QueryRenameProject(InteropSafeIVsProject3, oldFile, newFile, 0, out canContinue))
                && canContinue != 0) {
                ...
                SuspendFileChanges fileChanges = new SuspendFileChanges(Site, FileName);
                fileChanges.Suspend();
                try {
                    // Actual file rename
        ...
        protected virtual void SetOutputLogger(IVsOutputWindowPane output) {
            ...
            if (!useProvidedLogger || buildLogger == null) {
                ...
                if (null != registry) {
                    ...
                    IdeBuildLogger logger = BuildLogger as IdeBuildLogger;
        ...
        protected virtual void SetBuildConfigurationProperties(string config, string platform) {
            ...
            if (!string.IsNullOrEmpty(config) && !string.IsNullOrEmpty(platform)) {
                options = GetProjectOptions(config, platform);
            }
        ...
        protected virtual MSBuildResult InvokeMSBuild(string target) {
            ...
            IVsBuildManagerAccessor accessor = Site.GetService(typeof(SVsBuildManagerAccessor)) as IVsBuildManagerAccessor;
            ...
            if (buildProject != null) {
                ...
                try {
                    ...
                    BuildRequestData requestData = new BuildRequestData(currentConfig, targetsToBuild, BuildProject.ProjectCollection.HostServices, BuildRequestDataFlags.ReplaceExistingProjectInstance);
        ...
        protected virtual BuildSubmission DoMSBuildSubmission(BuildKind buildKind, string target, Action<MSBuildResult, string> uiThreadCallback) {
            ...
            BuildRequestData requestData = new BuildRequestData(projectInstance, targetsToBuild, BuildProject.ProjectCollection.HostServices, BuildRequestDataFlags.ReplaceExistingProjectInstance);
        ...
        protected virtual int SaveAs(string newFileName) {
            ...
            if (newFileName.Length > NativeMethods.MAX_PATH) {
                ...
                if (errorMessage.Length == 0) {
                    ...
                    if (String.IsNullOrEmpty(fileName) || fileName[0] == '.') {
                        ...
                        string oldUrl = Path.GetDirectoryName(Url);

                        if (!NativeMethods.IsSamePath(oldUrl, url)) {
                            errorMessage = String.Format(CultureInfo.CurrentCulture, SR.GetString(SR.SaveOfProjectFileOutsideCurrentDirectory, CultureInfo.CurrentUICulture), ProjectFolder);
                        }
                    }
                }
            }
            ...
            IVsSolution solution = Site.GetService(typeof(IVsSolution)) as IVsSolution;
            ...
            ErrorHandler.ThrowOnFailure(solution.QueryRenameProject(InteropSafeIVsProject3, FileName, newFileName, 0, out canRenameContinue));

            if (canRenameContinue == 0) {
                return VSConstants.OLE_E_PROMPTSAVECANCELLED;
            }

            SuspendFileChanges fileChanges = new SuspendFileChanges(Site, oldName);
            fileChanges.Suspend();
            try {
        ...
        protected virtual void SaveMSBuildProjectFileAs(string newFileName) {
            ...
            SetProjectProperty(ProjectFileConstants.Name, _PersistStorageType.PST_PROJECT_FILE, newFileNameWithoutExtension);
        ...
        public virtual ProjectElement AddFileToMSBuild(string file, string itemType, string subtype) {
            ...
            ProjectElement newItem = CreateMSBuildFileItem(itemPath, itemType);
        ...
        protected virtual ProjectElement AddFolderToMSBuild(string folder, string itemType) {
            ...
            string itemPath = PackageUtilities.MakeRelativeIfRooted(folder, BaseUri);
            Debug.Assert(!Path.IsPathRooted(itemPath), "Cannot add item with full path.");
        ...
        protected virtual int CanOverwriteExistingItem(string originalFileName, string computedNewFileName) {
            ...
            bool isOpen = VsShellUtilities.IsDocumentOpen(Site, computedNewFileName, Guid.Empty, out hier, out itemid, out windowFrame);
            ...
            int msgboxResult = VsShellUtilities.ShowMessageBox(Site, title, message, icon, buttons, defaultButton);
        ...
        public virtual bool IsCurrentStateASuppressCommandsMode() {
            ...
            DBGMODE dbgMode = VsShellUtilities.GetDebugMode(Site) & ~DBGMODE.DBGMODE_EncMask;
        ...
        public virtual void SetCurrentConfiguration() {
            ...
            SetConfiguration(Utilities.GetActiveConfigurationName(automationObject), Utilities.GetActivePlatformName(automationObject));
        }
        ...
        public virtual void SetConfiguration(string config, string platform) {
            ...
            bool propertiesChanged = buildProject.SetGlobalProperty(ProjectFileConstants.Configuration, config);
            propertiesChanged |= buildProject.SetGlobalProperty(ProjectFileConstants.Platform, ConfigProvider.GetPlatformPropertyFromPlatformName(platform));
            ...
            if (propertiesChanged || (designTimeAssemblyResolution == null && !designTimeAssemblyResolutionFailed)) {
                designTimeAssemblyResolutionFailed = false;
                ...
                try {
                    ...
                    designTimeAssemblyResolution = null;
                    designTimeAssemblyResolutionFailed = true;
                }
            }
        ...
        public virtual void ProcessFolders(IDictionary<string, HierarchyNode> nodeCache) {
            ...
            foreach (MSBuild.ProjectItem folder in buildProject.Items.Where(IsFolderItem).ToArray()) {
                ...
                CreateFolderNodes(strPath, nodeCache);
            }
        }
        ...
        public virtual void ProcessFiles(IDictionary<string, HierarchyNode> nodeCache) {
            ...
            // Process Files
            foreach (MSBuild.ProjectItem item in buildProject.Items.ToArray()) {
                // Ignore the item if it is a reference or folder
                if (FilterItemTypeToBeAddedToHierarchy(item.ItemType))
                    continue;
        ...
        public virtual void LoadNonBuildInformation() {
            IPersistXMLFragment outerHierarchy = InteropSafeIVsHierarchy as IPersistXMLFragment;
        ...
        protected virtual void OnHandleConfigurationRelatedGlobalProperties(object sender, ActiveConfigurationChangedEventArgs eventArgs) {
            ...
            if (eventArgs == null || eventArgs.Hierarchy == null || !Utilities.IsSameComObject(eventArgs.Hierarchy, InteropSafeIVsHierarchy)) {
                return;
            }
        ...
        public virtual void ResumeMSBuild(string config, string platform, IVsOutputWindowPane output, string target) {
            ...
            if (suspendMSBuildCounter == 0 && invokeMSBuildWhenResumed) {
                try {
                    Build(config, platform, output, target);
                } finally {
        ...
        public virtual void ResumeMSBuild(string config, string platform, string target) {
            ResumeMSBuild(config, platform, null, target);
        }
        ...
        public virtual void ResumeMSBuild(string target) {
            ResumeMSBuild(string.Empty, string.Empty, null, target);
        }
        ...
        public virtual MSBuildResult CallMSBuild(string config, string platform, IVsOutputWindowPane output, string target) {
            if (suspendMSBuildCounter > 0) {
                ...
                return Build(config, platform, output, target);
            }
        }
        ...
        public virtual MSBuildResult CallMSBuild(string config, string platform, string target) {
            return CallMSBuild(config, platform, null, target);
        }
        ...
        public virtual MSBuildResult CallMSBuild(string target) {
            return CallMSBuild(string.Empty, string.Empty, null, target);
        }
        ...
        public virtual MSBuildResult CallMSBuild(string target, IVsOutputWindowPane output) {
            return CallMSBuild(string.Empty, string.Empty, output, target);
        }
        ...
        public virtual MSBuildResult Build(string config, string platform, IVsOutputWindowPane output, string target) {
            return Build(0, config, platform, output, target);
        }
        ...
        public virtual MSBuildResult Build(string config, string platform, string target) {
            return Build(0, config, platform, null, target);
        }
        ...
        public virtual MSBuildResult Build(string target) {
            return Build(0, string.Empty, string.Empty, null, target);
        }
        ...
        public virtual MSBuildResult Build(string target, IVsOutputWindowPane output) {
            return Build(0, string.Empty, string.Empty, output, target);
        }
        ...
        public virtual string GetProjectProperty(string propertyName, _PersistStorageType storageType) {
            return GetProjectProperty(propertyName, storageType, true);
        }
        ...
        public virtual FolderNode CreateFolderNode(string path) {
            ProjectElement item = AddFolderToMSBuild(path);
        ...
        public virtual bool QueryEditProjectFile(bool suppressUI) {
            ...
            if (_site == null) {
                ...
                IVsQueryEditQuerySave2 queryEditQuerySave = GetService(typeof(SVsQueryEditQuerySave)) as IVsQueryEditQuerySave2;
        ...
        public virtual NestedProjectNode GetNestedProjectForHierarchy(IVsHierarchy hierarchy) {
            ...
            if (project != null) {
                ...
                if (!String.IsNullOrEmpty(mkDocument)) {
                    HierarchyNode node = FindChild(mkDocument);
        ...
        public virtual MSBuildConstruction.ProjectExtensionsElement GetProjectExtensions() {
            var extensionsElement = buildProject.Xml.ChildrenReversed.OfType<MSBuildConstruction.ProjectExtensionsElement>().FirstOrDefault();
        ...
        protected virtual void RegisterSccProject() {
            ...
            if (IsSccDisabled || isRegisteredWithScc || String.IsNullOrEmpty(_sccProjectName)) {
                return;
            }
            ...
            if (sccManager != null) {
                ErrorHandler.ThrowOnFailure(sccManager.RegisterSccProject(InteropSafeIVsSccProject2, _sccProjectName, _sccAuxPath, _sccLocalPath, _sccProvider));
        ...
        protected virtual void PersistXmlFragments() {
            if (IsFlavorDirty() != 0) {
                ...
                IVsCfg[] configs = null;
                int hr = ConfigProvider.GetCfgs(0, null, count, null);
        ...
        public virtual int AddItemWithSpecific(uint itemIdLoc, VSADDITEMOPERATION op, string itemName, uint filesToOpen, string[] files, IntPtr dlgOwner, uint editorFlags, ref Guid editorType, string physicalView, ref Guid logicalView, VSADDRESULT[] result) {
            ...
            string baseDir = GetBaseDirectoryForAddingFiles(n);
            ...
            for (int index = 0; index < filesToAdd.Count; index++) {
                ...
                if (child != null) {
                    ...
                    int canOverWriteExistingItem = CanOverwriteExistingItem(file, newFileName);
                ...
                if (op != VSADDITEMOPERATION.VSADDITEMOP_LINKTOFILE && NativeMethods.IsSamePath(file, newFileName) == false) {
                    if (!overwrite && File.Exists(newFileName)) {
                        ...
                        OLEMSGDEFBUTTON defaultButton = OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST;
                        int messageboxResult = VsShellUtilities.ShowMessageBox(Site, title, message, icon, buttons, defaultButton);
                    ...
                    IVsFileChangeEx fileChange = _site.GetService(typeof(SVsFileChangeEx)) as IVsFileChangeEx;
                    if (fileChange == null) {
                        throw new InvalidOperationException();
                    }
                ...
                if (overwrite) {
                    ...
                    Url baseUrl = new Url(ProjectFolder + Path.DirectorySeparatorChar);
                    string relativePath = baseUrl.MakeRelative(new Url(file));
                    string linkPath = baseUrl.MakeRelative(new Url(newFileName));
                    AddNewFileNodeToHierarchy(n, relativePath, linkPath);
                } else {
                    //Add new filenode/dependentfilenode
                    AddNewFileNodeToHierarchy(n, newFileName, null);
                }
                    ...
                    if (!String.IsNullOrEmpty(actualFiles[i])) {
                        ...
                        if (child != null) {
                            ...
                            if (editorType == Guid.Empty) {
                                ...
                                ErrorHandler.ThrowOnFailure(OpenItemWithSpecific(child.Id, editorFlags, ref editorType, physicalView, ref logicalView, IntPtr.Zero, out frame));
                            }
        ...
        public virtual int GetItemContext(uint itemId, out Microsoft.VisualStudio.OLE.Interop.IServiceProvider psp) {
            CciTracing.TraceCall();
            psp = null;
            HierarchyNode child = NodeFromItemId(itemId);
            if (child != null) {
        ...
        public virtual int IsDocumentInProject(string mkDoc, out int found, VSDOCUMENTPRIORITY[] pri, out uint itemId) {
            ...
            if (NativeMethods.IsSamePath(mkDoc, GetMKDocument())) {
                ...
                HierarchyNode child = FindChild(mkDoc);
                if (child != null) {
                    found = 1;
                    itemId = child.Id;
                }
        ...
        public virtual int SetHostObject(string targetName, string taskName, object hostObject) {
            ...
            buildProject.ProjectCollection.HostServices.RegisterHostObject(buildProject.FullPath, targetName, taskName, (Microsoft.Build.Framework.ITaskHost)hostObject);
        ...
        public virtual int BuildTarget(string targetName, out bool success) {
            ...
            MSBuildResult result = Build(targetName);
        ...
        public virtual IVsBuildDependency[] BuildDependencies {
            get {
                return buildDependencyList.ToArray();
            }
        }
        ...
        public virtual bool IsProjectEventsListener {
            get { return isProjectEventsListener; }
            set { isProjectEventsListener = value; }
        }
        #endregion
        ...
        public virtual int GetAggregateProjectTypeGuids(out string projectTypeGuids) {
            projectTypeGuids = GetProjectProperty(ProjectFileConstants.ProjectTypeGuids, _PersistStorageType.PST_PROJECT_FILE);
        ...
        public virtual int SetAggregateProjectTypeGuids(string projectTypeGuids) {
            SetProjectProperty(ProjectFileConstants.ProjectTypeGuids, _PersistStorageType.PST_PROJECT_FILE, projectTypeGuids);
            return VSConstants.S_OK;
        }
        ...
        int IVsBuildPropertyStorage.GetPropertyValue(string propertyName, string configName, uint storage, out string propertyValue) {
            ...
            if (string.IsNullOrEmpty(configName)) {
                propertyValue = GetProjectProperty(propertyName, (_PersistStorageType)storage);
            } else {
                IVsCfg configurationInterface;
                ErrorHandler.ThrowOnFailure(ConfigProvider.GetCfgOfName(configName, string.Empty, out configurationInterface));
        ...
        int IVsBuildPropertyStorage.SetPropertyValue(string propertyName, string configName, uint storage, string propertyValue) {
            // TODO: when adding support for User files, we need to update this method
            if (string.IsNullOrEmpty(configName)) {
                SetProjectProperty(propertyName, (_PersistStorageType)storage, propertyValue);
            } else {
                IVsCfg configurationInterface;
                ErrorHandler.ThrowOnFailure(ConfigProvider.GetCfgOfName(configName, string.Empty, out configurationInterface));
                ProjectConfig config = (ProjectConfig)configurationInterface;
        ...
        public virtual int GetTargetFramework(out string ppTargetFramework) {
            ppTargetFramework = ProjectManager.TargetFrameworkMoniker.FullName;
            return VSConstants.S_OK;
        }
        ...
        protected virtual HierarchyNode AddIndependentFileNode(MSBuild.ProjectItem item, IDictionary<string, HierarchyNode> parentNodeCache) {
            ...
            if (String.IsNullOrEmpty(linkPath)) {
                string projectFolder = new Uri(ProjectFolder).LocalPath;
                string itemPath = new Uri(Path.Combine(ProjectFolder, item.EvaluatedInclude)).LocalPath;
        ...
        protected virtual HierarchyNode AddFileNodeToNode(MSBuild.ProjectItem item, HierarchyNode parentNode) {
            FileNode node = CreateFileNode(new ProjectElement(this, item, false));
            parentNode.AddChild(node);
            return node;
        }
        ...
        protected virtual HierarchyNode GetItemParentNode(MSBuild.ProjectItem item, IDictionary<string, HierarchyNode> nodeCache) {
            ...
            if (strPath.Length > 0) {
                if (!nodeCache.TryGetValue(strPath, out currentParent)) {
                    ...
                    currentParent = CreateFolderNodes(strPath, nodeCache);
        ...
        protected virtual MSBuildExecution.ProjectPropertyInstance GetMsBuildProperty(string propertyName, _PersistStorageType storageType, bool resetCache) {
            ProjectInstance projectInstance = currentConfig;
            if (resetCache || currentConfig == null || storageType == _PersistStorageType.PST_USER_FILE) {
                // Get properties from project file and cache it
                SetCurrentConfiguration();
                currentConfig = buildProject.CreateProjectInstance();
                if (storageType == _PersistStorageType.PST_PROJECT_FILE)
                    projectInstance = currentConfig;
        ...
        protected virtual bool SetSccSettings(string sccProjectName, string sccLocalPath, string sccAuxPath, string sccProvider) {
            ...
            if (!String.Equals(sccProjectName, _sccProjectName, StringComparison.OrdinalIgnoreCase) ||
                !String.Equals(sccLocalPath, _sccLocalPath, StringComparison.OrdinalIgnoreCase) ||
                !String.Equals(sccAuxPath, _sccAuxPath, StringComparison.OrdinalIgnoreCase) ||
                !String.Equals(sccProvider, _sccProvider, StringComparison.OrdinalIgnoreCase)) {
                changed = true;
                _sccProjectName = sccProjectName;
                _sccLocalPath = sccLocalPath;
                _sccAuxPath = sccAuxPath;
        ...
        protected virtual void InitSccInfo() {
            _sccProjectName = GetProjectProperty(ProjectFileConstants.SccProjectName, _PersistStorageType.PST_PROJECT_FILE);
            _sccLocalPath = GetProjectProperty(ProjectFileConstants.SccLocalPath, _PersistStorageType.PST_PROJECT_FILE);
            _sccProvider = GetProjectProperty(ProjectFileConstants.SccProvider, _PersistStorageType.PST_PROJECT_FILE);
            _sccAuxPath = GetProjectProperty(ProjectFileConstants.SccAuxPath, _PersistStorageType.PST_PROJECT_FILE);
        }
        ...
        protected virtual void SetProjectGuidFromProjectFile() {
            string projectGuid = GetProjectProperty(ProjectFileConstants.ProjectGuid, _PersistStorageType.PST_PROJECT_FILE);
        ...
        protected virtual void SetupProjectGlobalPropertiesThatAllProjectSystemsMustSet() {
            ...
            IVsShell shell = Site.GetService(typeof(SVsShell)) as IVsShell;
            if (shell != null) {
                // We do not want to throw. If we cannot set the solution related constants we set them to empty string.
        ...
        protected virtual bool TryBeginBuild(bool designTime, bool requiresUIThread = false) {
            ...
            try {
                ...
                if (accessor != null) {
                    ...
                    BuildParameters buildParameters = new BuildParameters(buildEngine ?? ProjectCollection.GlobalProjectCollection);
        ...
        protected virtual string GetComponentPickerDirectories() {
            IVsComponentEnumeratorFactory4 enumFactory = _site.GetService(typeof(SCompEnumService)) as IVsComponentEnumeratorFactory4;
            if (enumFactory == null) {
        ...
        protected virtual bool ShowRetargetingDialog() {
            var retargetDialog = _site.GetService(typeof(SVsFrameworkRetargetingDlg)) as IVsFrameworkRetargetingDlg;
            ...
            if (IsIdeInCommandLineMode) {
                string message = SR.GetString(SR.CannotLoadUnknownTargetFrameworkProject, FileName, TargetFrameworkMoniker);
                var outputWindow = _site.GetService(typeof(SVsOutputWindow)) as IVsOutputWindow;
                    ...
                    case __FRD_OUTCOME.FRDO_RETARGET_TO_40:
                        ...
                        if (QueryEditProjectFile(false /* bSuppressUI */)) {
                            ...
                            if (retargetingService != null) {
                                ...
                                Marshal.ThrowExceptionForHR(retargetingService.BatchRetargetProject(InteropSafeIVsHierarchy, DefaultTargetFrameworkMoniker.FullName, true));
        ...
        protected virtual bool IsFrameworkOnMachine() {
            var multiTargeting = _site.GetService(typeof(SVsFrameworkMultiTargeting)) as IVsFrameworkMultiTargeting;
            Array frameworks;
