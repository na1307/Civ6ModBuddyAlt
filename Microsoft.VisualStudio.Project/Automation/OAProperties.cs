...
namespace Microsoft.VisualStudio.Project.Automation {
    ...
    public class OAProperties : EnvDTE.Properties {
        ...
        private readonly Dictionary<string, EnvDTE.Property> properties = new();
        #endregion
        ...
        public virtual EnvDTE.DTE DTE {
            get {
                return UIThread.DoOnUIThread(delegate () {
                    if (target == null || target.Node == null || target.Node.ProjectManager == null || target.Node.ProjectManager.IsClosed ||
                        target.Node.ProjectManager.Site == null) {
                        throw new InvalidOperationException();
                    }
                    return target.Node.ProjectManager.Site.GetService(typeof(EnvDTE.DTE)) as EnvDTE.DTE;
                });
            }
        }
