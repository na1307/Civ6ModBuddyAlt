...
namespace Microsoft.VisualStudio.Project {
    ...
    public abstract class ProjectContainerNode : ProjectNode,
        ...
        public override int ReloadItem(uint itemId, uint reserved) {
            ...
            NestedProjectNode node = NodeFromItemId(itemId) as NestedProjectNode;
        ...
        public virtual NestedProjectNode AddExistingNestedProject(ProjectElement element, __VSCREATEPROJFLAGS creationFlags) {
            ProjectElement elementToUse = (element == null) ? nestedProjectElement : element;
        ...
        public void RunVSTemplateWizard(ProjectElement element, bool silent) {
            ...
            string template = GetProjectTemplatePath(elementToUse);
        ...
        public virtual NestedProjectNode AddNestedProjectFromTemplate(ProjectElement element, __VSCREATEPROJFLAGS creationFlags) {
            ...
            return AddNestedProjectFromTemplate(template, Path.GetDirectoryName(destination), Path.GetFileName(destination), elementToUse, creationFlags);
        }
        ...
        protected virtual string GetProjectTemplatePath(ProjectElement element) {
            ...
            if (!Path.IsPathRooted(templateFile)) {
                RegisteredProjectType registeredProjectType = GetRegisteredProject(elementToUse);
        ...
        protected virtual RegisteredProjectType GetRegisteredProject(ProjectElement element) {
            ...
            EnvDTE.DTE dte = ProjectManager.Site.GetService(typeof(EnvDTE.DTE)) as EnvDTE.DTE;
        ...
        protected virtual void ReloadNestedProjectNode(NestedProjectNode node) {
            ...
            try {
                ...
                EventTriggeringFlag = SuppressEvents.Tracker;
                ...
                if (newNode == null || newNode.NestedHierarchy == null) {
                    ErrorHandler.ThrowOnFailure(solution.CloseSolutionElement((uint)__VSSLNCLOSEOPTIONS.SLNCLOSEOPT_UnloadProject | (uint)__VSSLNSAVEOPTIONS.SLNSAVEOPT_ForceSave, InteropSafeIVsHierarchy, 0));
                } else {
                    EventTriggeringFlag = SuppressEvents.None;
                }
            }
        ...
        protected virtual void OnNestedProjectFileChangedOnDisk(object sender, FileChangedOnDiskEventArgs e) {
            ...
            if (!Utilities.IsInAutomationFunction(Site)) {
                ...
                OLEMSGDEFBUTTON defaultButton = OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST;
                reload = VsShellUtilities.ShowMessageBox(Site, message, title, icon, buttons, defaultButton) == DialogResult.Yes;
            }
