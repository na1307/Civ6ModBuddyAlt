...
public partial class Civ6PathUserControl : UserControl {
    ...
    private void textBox1_TextChanged(object sender, EventArgs e) => optionsPage.UserPath = textBox1.Text;
    ...
    private void textBox2_TextChanged(object sender, EventArgs e) => optionsPage.GamePath = textBox2.Text;
    ...
    private void textBox3_TextChanged(object sender, EventArgs e) => optionsPage.ToolsPath = textBox3.Text;
    ...
    private void textBox4_TextChanged(object sender, EventArgs e) => optionsPage.AssetsPath = textBox4.Text;
